...
function StartYourJourney() {
    return (
        <div className='px-[5%]'>
            <div className="max-w-screen-xl mx-auto py-10 sm:mt-14 sm:mb-7">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 relative">
                    {/* card no 1 */}
                    <div className="h-[450px] py-10 rounded-sm relative overflow-hidden group bg-light-bg hover:bg-accent-gold transition duration-700">
                    ...
                    {/* card no 2 */}
                    <div className="group h-[450px] rounded-sm py-10 relative overflow-hidden bg-light-bg hover:bg-accent-gold transition duration-700">
                        <div className="flex flex-col items-center justify-center gap-4 relative z-10">
                        ...
                        <Image src={sellImages} alt='buy a home icon' width={450} height={220} className='absolute bottom-0 left-0 z-0' />
                    </div>


                    {/* card no 3 */}
                    <div className="h-[450px] bg-light-bg rounded-sm py-10 relative overflow-hidden hover:bg-accent-gold transition duration-700 group">
                        <div className="flex flex-col items-center justify-center gap-4 relative z-10">
                        ...
                        <Image src={rentImages} alt='buy a home icon' width={450} height={220} className='absolute bottom-0 left-0 z-0' />
                    </div>
                </div>
            </div>
        </div>
