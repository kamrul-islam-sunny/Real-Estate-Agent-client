            ...
            <section className="px-[5%]">
                <div className="max-w-screen-xl mx-auto text-center py-20">
                    <h2 className="text-3xl sm:text-[56px] font-anton  text-center">
                        Reach out & <span className="text-accent-gold">let’s <br /><span className="text-accent-brown">start</span></span> a conversation
                    </h2>
                    <p className="mt-5 text-gray-600 max-w-xl mx-auto">
                        If you have any questions about the real estate market, I’d love to chat.
                        Reach out below, and I’ll get back to you shortly.
                    </p>
                </div>
                ...
                <div className="bg-[#f9f9f9] p-6 sm:py-12 sm:px-14 rounded max-w-5xl mx-auto">
                    <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 gap-6 font-nunito">
                        {/* First Name */}
                        <div>
                            <label className="block mb-1 text-lg font-medium text-gray-700">First Name*</label>
                            <input
                                type="text"
                            ...
                            />
                            {errors.firstName && <p className="text-red-500 text-lg mt-1">First name is required</p>}
                        </div>

                        {/* Last Name */}
                        <div>
                            <label className="block mb-1 text-lg font-medium text-gray-700">Last Name*</label>
                            <input
                                type="text"
                                ...
                                className="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-accent-gold"
                            />
                            {errors.lastName && <p className="text-red-500 text-lg mt-1">Last name is required</p>}
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-accent-gold"
                            />
                            {errors.email && <p className="text-red-500 text-lg mt-1">Email is required</p>}
                        </div>

                        {/* Phone */}
                        <div>
                            <label className="block mb-1 text-lg font-medium text-gray-700">Phone*</label>
                            <input
                                type="tel"
                                ...
                                className="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-accent-gold"
                            />
                            {errors.phone && <p className="text-red-500 text-lg mt-1">Phone number is required</p>}
                        </div>
                        ...
                        <div className="md:col-span-2">
                            ...
                            <textarea
                                ...
                                className="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-accent-gold"
                            ></textarea>
                            {errors.message && <p className="text-red-500 text-lg mt-1">Message is required</p>}
                        </div>
