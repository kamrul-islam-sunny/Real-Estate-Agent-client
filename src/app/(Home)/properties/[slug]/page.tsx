...
export default function PropertyDetails() {
    ...
    console.log(slug)
    const { data, isLoading } = useHandleFindSinglePropertiesQuery(slug)
    const property = data?.payload.data

    // console.log(property)
    // console.log(property?.details)
    // http://localhost:5000/api/v1/property/find?page=1&limit=10&location=&sale=&minPrice=&maxPrice=&bedrooms=&bathrooms=&squareFeet=
